...
public class ViewBaiaAmostradosP extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewBaiaAmostradosP
     */
    ...
    private void initComponents() {
        ...
        try {
            baia1JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        try {
            nasa11JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        peso11JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso11JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso11JFT.setEnabled(false);

        nasa21JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa21JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa21JFT.setEnabled(false);

        peso21JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        ...
        try {
            baia3JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        try {
            baia4JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        try {
            baia5JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        nasa12JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa12JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa12JFT.setEnabled(false);

        nasa13JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa13JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa13JFT.setEnabled(false);

        nasa14JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa14JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa14JFT.setEnabled(false);

        nasa15JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa15JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa15JFT.setEnabled(false);

        peso12JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso12JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso12JFT.setEnabled(false);

        peso13JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso13JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso13JFT.setEnabled(false);

        peso14JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso14JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso14JFT.setEnabled(false);

        peso15JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso15JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso15JFT.setEnabled(false);

        nasa22JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa22JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa22JFT.setEnabled(false);

        nasa23JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa23JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa23JFT.setEnabled(false);

        nasa24JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa24JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa24JFT.setEnabled(false);

        nasa25JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("###"))));
        nasa25JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nasa25JFT.setEnabled(false);

        peso22JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso22JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso22JFT.setEnabled(false);

        peso23JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso23JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso23JFT.setEnabled(false);

        peso24JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        peso24JFT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        peso24JFT.setEnabled(false);

        peso25JFT.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        ...
        baiaAmostradosJPLayout.setHorizontalGroup(
            ...
            .addGroup(baiaAmostradosJPLayout.createSequentialGroup()
                ...
                .addGroup(baiaAmostradosJPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(ordem4JFT)
                    .addComponent(ordem3JFT)
                ...
                .addGroup(baiaAmostradosJPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(baiaHist3Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(baia2JFT)
                    .addComponent(baia3JFT)
                    .addComponent(baia4JFT)
                    .addComponent(baia5JFT))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(baiaAmostradosJPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(nasa11JFT)
                    .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa1Hist1Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa1Hist2Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa1Hist3Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa1Hist4Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa1Hist5Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa12JFT)
                    .addComponent(nasa13JFT)
                    .addComponent(nasa14JFT)
                ...
                .addGroup(baiaAmostradosJPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(nasa2Hist1Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa2Hist2Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa2Hist3Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa2Hist4Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa2Hist5Label, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(nasa22JFT)
                    .addComponent(nasa23JFT)
                    .addComponent(nasa24JFT)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBaiaAmostradosP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
