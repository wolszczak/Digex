...
public class ViewEscolhaCamaraP extends javax.swing.JFrame {

    /**
     * Creates new form ViewEscolhaCamaraP
     */
    public ViewEscolhaCamaraP() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel37.setText("Selecione qual câmara digitar:");

        abate1Label.setText("[1] - Câmara 1");
        ...
        abate2Label.setText("[2] - Câmara 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEscolhaCamaraP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEscolhaCamaraP().setVisible(true);
            }
        });
    }
