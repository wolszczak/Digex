...
public class ControllerP {
	...
	private ControllerDesempenhoVersoP ctrlDesempenhoVerso;
	...
	public void startEscolhaDigRend(Integer abate, Integer idadeAbate, String dataAbate) {
		...
		ctrlEscolhaDigRend.openWindow(modelP.getExperimentoVO().getInfoExp().getAviario(), abate, idadeAbate,
				dataAbate);
	}
	...
	public void startBaiaAmostrados(Integer aviario, Integer abate, Integer idadeAbate, String dataAbate) {
		...
		ctrlBaiaAmostrados.openWindow(modelP.getExperimentoVO().getInfoExp().getAviario(), abate, idadeAbate,
				dataAbate);
	}
	...
	public void startEscolhaCamaras(Integer aviario, Integer abate, Integer idadeAbate, String dataAbate) {
		...
		ctrlEscolhaCamaraP.openWindow(modelP.getExperimentoVO().getInfoExp().getAviario(), abate, idadeAbate,
				dataAbate);
	}
	...
	public void startEscolhaCones(Integer aviario, Integer abate, Integer idadeAbate, String dataAbate,
			Integer camara) {
		ctrlEscolhaConeP = new ControllerEscolhaConeP(this);
		ctrlEscolhaConeP.openWindow(modelP.getExperimentoVO().getInfoExp().getAviario(), abate, idadeAbate, dataAbate,
				camara);
	}

	public void startCones(Integer aviario, Integer abate, Integer idadeAbate, String dataAbate, Integer camara,
			Integer cone) {
		ctrlCone = new ControllerConeP(this);
		ctrlCone.openWindow(modelP.getExperimentoVO().getInfoExp().getAviario(), abate, idadeAbate, dataAbate, camara,
				cone);
	}
}