...
public class InfoExpVOP implements Serializable {
	...
	public InfoExpVOP(String idDigitador, String protocolo, int local, String local1, int aviario, String teste, int cama, int tipo,
			String tipo1, int nrBaias, String inicioExp, String fimExp, int idadeAloj, int equalizacao, int nrFases,
			List<Integer> idadeFase, int nrAbate, List<String> dataAbate, int erro1, int erro2, int erro3, int erro4, int erro5, int erro6,
			int erro7, int erro8, int aleijado1, int aleijado2, int aleijado3, int aleijado4, int aleijado5, int aleijado6, int aleijado7,
			int aleijado8) {
	...
	public boolean equals(Object obj) {
		...
		final InfoExpVOP other = (InfoExpVOP) obj;
