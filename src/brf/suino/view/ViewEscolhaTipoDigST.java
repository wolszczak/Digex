...
public class ViewEscolhaTipoDigST extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		lblDigitar_1 = new JLabel();
		lblDigitar_1.setText("[4] - Digitar Consumo última baia");
				...
				.addGroup(jPanel11Layout.createSequentialGroup()
					...
					.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
							.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
								.addComponent(abate1Label, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
						...
						.addComponent(jLabel39, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
						.addComponent(jLabel40, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
						.addGroup(Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
						...
						.addGroup(Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
							.addComponent(jLabel41, GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
							.addComponent(lblDigitar_1, GroupLayout.PREFERRED_SIZE, 278, GroupLayout.PREFERRED_SIZE)
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ViewEscolhaTipoDigST.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ViewEscolhaTipoDigST().setVisible(true);
			}
		});
	}
