...
public class DesempenhoVOSC implements Serializable {
	private static final long serialVersionUID = 1L;
	private int baia, sexo, lado, linhagem, trata, nrAlojados;
//	private List<RmeVO> consumo;
	private boolean finalizado;

	public DesempenhoVOSC(int baia, int sexo, int lado, int linhagem, int trata, int nrAlojados,/* List<RmeVOP> consumo,*/ boolean finalizado) {
		this.baia = baia;
		this.sexo = sexo;
		this.lado = lado;
