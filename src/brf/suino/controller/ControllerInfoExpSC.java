...
public class ControllerInfoExpSC extends KeyAdapter implements ActionListener, FocusListener, ItemListener {
	...
	private InfoExpVOSC info1, info2;
	private ViewInfoExpSC view1, view2;
	private boolean duplaDigitacao;
	private Border defaultJTF, defaultJCB, defaultJP;

	public ControllerInfoExpSC(ControllerSC c) {
		this.controller = c;
