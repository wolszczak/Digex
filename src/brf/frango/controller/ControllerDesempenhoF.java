...
public class ControllerDesempenhoF extends KeyAdapter
    ...
    public void loadHist() {
        ...
        if(!desempenho.isEmpty()) {
            ...
            viewDesempenho.getControleBaiaJFT().setText(""+desempenho.get(desempenho.size()-1).getControleBaia());
        ...
        TextFormatter.formatStringJFT(viewDesempenho.getOrdemRMEJFT(), viewDesempenho.getOrdemRMEJFT().getText(), 3);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_LEFT 
                && !e.getSource().equals(viewDesempenho.getBaiaJFT())
            ...
            if (!e.getSource().equals(viewDesempenho.getOpcaoJFT())) {
                prev = viewDesempenho.getFocusTraversalPolicy().getComponentBefore(viewDesempenho, (JFormattedTextField) src);
            } else {
    ...
    public void keyTyped(KeyEvent e) {
        if ((JFormattedTextField) e.getSource() == viewDesempenho.getOpcaoJFT()) {
            switch (e.getKeyChar()) {
                case KeyEvent.VK_0:
                    int n = JOptionPane.showConfirmDialog(viewDesempenho,
            ...
            if ((JFormattedTextField) e.getSource() == viewDesempenho.getBaiaJFT()) {
                ...
                if (controleBaia != somaControle) {
                    ...
                    String msg = desempenhoBO.verificaCabecalho(Integer.parseInt(viewDesempenho.getBaiaJFT().getText()),
                            ...
                            Integer.parseInt(viewDesempenho.getAvesAlojadasJFT().getText()));
                    if (msg.length() != 0) {
                        JOptionPane.showMessageDialog(viewDesempenho,
                                "Problema(s):\n" + msg, "DIGEX - Erro",
...
//          RME
                ...
                if (controlePesagem != somaControleP) {
                    ...
                    if (msg.length() != 0) {
                        ...
                        desempenho.add(new DesempenhoVOF(Integer.parseInt(viewDesempenho.getBaiaJFT().getText()),
                                ...
                                Integer.parseInt(viewDesempenho.getTrat2JFT().getText()),
                                Integer.parseInt(viewDesempenho.getAvesAlojadasJFT().getText()),
                                Integer.parseInt(viewDesempenho.getControleBaiaJFT().getText()),
                                rme,
                                pesagem));
    ...
    public void recuperaHistRME() {
        ...
        TextFormatter.formatStringJFT(viewDesempenho.getIdadeRacaoJFT(), viewDesempenho.getIdadeRacaoJFT().getText(), 2);
        ...
        TextFormatter.formatStringJFT(viewDesempenho.getIdadeMortalidadeJFT(), viewDesempenho.getIdadeMortalidadeJFT().getText(), 2);
        ...
        TextFormatter.formatStringJFT(viewDesempenho.getIdadeEliminadosJFT(), viewDesempenho.getIdadeEliminadosJFT().getText(), 2);
        ...
        TextFormatter.formatStringJFT(viewDesempenho.getControleRmeJFT(), viewDesempenho.getControleRmeJFT().getText(), 5);
