...
public class ControllerRendimentoF extends KeyAdapter implements FocusListener {
	...
	public void keyTyped(KeyEvent e) {
		if ((JFormattedTextField) e.getSource() == viewRendimento.getOpcaoJFT()) {
			switch (e.getKeyChar()) {
			case KeyEvent.VK_0:
				int n = JOptionPane.showConfirmDialog(viewRendimento, "Deseja realmente sair do programa?", "DIGEX - Sair",
				...
				break;
			case KeyEvent.VK_1:
				int option1 = JOptionPane.showConfirmDialog(viewRendimento, "Deseja realmente voltar para tela principal?",
						"DIGEX - Finalizar Abate " + abate, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
				if (option1 == 0) {
				...
				break;
			case KeyEvent.VK_9:
				int option9 = JOptionPane.showConfirmDialog(viewRendimento, "Deseja realmente voltar para tela anterior?", "DIGEX - Voltar",
						JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
				if (option9 == 0) {
					viewRendimento.setVisible(false);
		...
		if (e.getKeyChar() == KeyEvent.VK_ESCAPE) {
			int option = JOptionPane.showConfirmDialog(viewRendimento, "Deseja realmente voltar para tela anterior?", "DIGEX - Voltar",
					JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
			if (option == 0) {
				viewRendimento.setVisible(false);
				controller.resumeEscolhaBal();
			...
			if ((JFormattedTextField) e.getSource() == viewRendimento.getNumJFT1()) {
				...
				int somaControle = Integer.parseInt(viewRendimento.getNumJFT1().getText())
						+ Integer.parseInt(viewRendimento.getNumJFT2().getText()) + Integer.parseInt(viewRendimento.getNumJFT3().getText())
						+ Integer.parseInt(viewRendimento.getNumJFT4().getText()) + Integer.parseInt(viewRendimento.getNumJFT5().getText())
						...
						+ Integer.parseInt(viewRendimento.getPadJFT1().getText()) + Integer.parseInt(viewRendimento.getPadJFT2().getText())
						+ Integer.parseInt(viewRendimento.getPadJFT3().getText()) + Integer.parseInt(viewRendimento.getPadJFT4().getText())
						+ Integer.parseInt(viewRendimento.getPadJFT5().getText()) + Integer.parseInt(viewRendimento.getPaeJFT1().getText())
						+ Integer.parseInt(viewRendimento.getPaeJFT2().getText()) + Integer.parseInt(viewRendimento.getPaeJFT3().getText())
						+ Integer.parseInt(viewRendimento.getPaeJFT4().getText()) + Integer.parseInt(viewRendimento.getPaeJFT5().getText())
				...
				if (controle != somaControle) {
					...
					if (msgInexistente.length() != 0) {
						JOptionPane.showMessageDialog(viewRendimento, "Aviso(s):\n" + msgInexistente, "DIGEX - Aviso",
								JOptionPane.WARNING_MESSAGE);
					}
					String msgErros = rendimentoBO.verificaErros(abate, Integer.parseInt(viewRendimento.getNumJFT1().getText()),
							Integer.parseInt(viewRendimento.getNumJFT2().getText()),
							Integer.parseInt(viewRendimento.getNumJFT3().getText()),
							Integer.parseInt(viewRendimento.getNumJFT4().getText()),
							Integer.parseInt(viewRendimento.getNumJFT5().getText()));
					if (msgErros.length() != 0) {
						JOptionPane.showMessageDialog(viewRendimento, "Problema(s):\n" + msgErros, "DIGEX - Erro",
...
//        viewRendimento.getFdeJFT().setText("0");
	...
	public void lastHistNok() {
		...
		lastHist.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel1().getText()),
				Integer.parseInt(viewRendimento.getNumJFT1().getText()), Integer.parseInt(viewRendimento.getgDirJFT1().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT1().getText()), Integer.parseInt(viewRendimento.getpCarcJFT1().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT1().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT1().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT1().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT1().getText()),
				Integer.parseInt(viewRendimento.getpPeitoJFT1().getText()), Integer.parseInt(viewRendimento.getPadJFT1().getText()),
				Integer.parseInt(viewRendimento.getPaeJFT1().getText()), Integer.parseInt(viewRendimento.getEstPDirJFT1().getText()),
				Integer.parseInt(viewRendimento.getEstPEsqJFT1().getText()), Integer.parseInt(viewRendimento.getLargPeitoJFT1().getText()),
				Integer.parseInt(viewRendimento.getCompPeitoJFT1().getText()), Integer.parseInt(viewRendimento.getpCoxaJFT1().getText())));

		lastHist.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel2().getText()),
				Integer.parseInt(viewRendimento.getNumJFT2().getText()), Integer.parseInt(viewRendimento.getgDirJFT2().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT2().getText()), Integer.parseInt(viewRendimento.getpCarcJFT2().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT2().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT2().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT2().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT2().getText()),
				Integer.parseInt(viewRendimento.getpPeitoJFT2().getText()), Integer.parseInt(viewRendimento.getPadJFT2().getText()),
				Integer.parseInt(viewRendimento.getPaeJFT2().getText()), Integer.parseInt(viewRendimento.getEstPDirJFT2().getText()),
				Integer.parseInt(viewRendimento.getEstPEsqJFT2().getText()), Integer.parseInt(viewRendimento.getLargPeitoJFT2().getText()),
				Integer.parseInt(viewRendimento.getCompPeitoJFT2().getText()), Integer.parseInt(viewRendimento.getpCoxaJFT2().getText())));

		lastHist.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel3().getText()),
				Integer.parseInt(viewRendimento.getNumJFT3().getText()), Integer.parseInt(viewRendimento.getgDirJFT3().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT3().getText()), Integer.parseInt(viewRendimento.getpCarcJFT3().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT3().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT3().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT3().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT3().getText()),
				Integer.parseInt(viewRendimento.getpPeitoJFT3().getText()), Integer.parseInt(viewRendimento.getPadJFT3().getText()),
				Integer.parseInt(viewRendimento.getPaeJFT3().getText()), Integer.parseInt(viewRendimento.getEstPDirJFT3().getText()),
				Integer.parseInt(viewRendimento.getEstPEsqJFT3().getText()), Integer.parseInt(viewRendimento.getLargPeitoJFT3().getText()),
				Integer.parseInt(viewRendimento.getCompPeitoJFT3().getText()), Integer.parseInt(viewRendimento.getpCoxaJFT3().getText())));

		lastHist.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel4().getText()),
				Integer.parseInt(viewRendimento.getNumJFT4().getText()), Integer.parseInt(viewRendimento.getgDirJFT4().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT4().getText()), Integer.parseInt(viewRendimento.getpCarcJFT4().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT4().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT4().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT4().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT4().getText()),
				Integer.parseInt(viewRendimento.getpPeitoJFT4().getText()), Integer.parseInt(viewRendimento.getPadJFT4().getText()),
				Integer.parseInt(viewRendimento.getPaeJFT4().getText()), Integer.parseInt(viewRendimento.getEstPDirJFT4().getText()),
				Integer.parseInt(viewRendimento.getEstPEsqJFT4().getText()), Integer.parseInt(viewRendimento.getLargPeitoJFT4().getText()),
				Integer.parseInt(viewRendimento.getCompPeitoJFT4().getText()), Integer.parseInt(viewRendimento.getpCoxaJFT4().getText())));

		lastHist.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel5().getText()),
				Integer.parseInt(viewRendimento.getNumJFT5().getText()), Integer.parseInt(viewRendimento.getgDirJFT5().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT5().getText()), Integer.parseInt(viewRendimento.getpCarcJFT5().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT5().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT5().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT5().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT5().getText()),
				Integer.parseInt(viewRendimento.getpPeitoJFT5().getText()), Integer.parseInt(viewRendimento.getPadJFT5().getText()),
				Integer.parseInt(viewRendimento.getPaeJFT5().getText()), Integer.parseInt(viewRendimento.getEstPDirJFT5().getText()),
				Integer.parseInt(viewRendimento.getEstPEsqJFT5().getText()), Integer.parseInt(viewRendimento.getLargPeitoJFT5().getText()),
				Integer.parseInt(viewRendimento.getCompPeitoJFT5().getText()), Integer.parseInt(viewRendimento.getpCoxaJFT5().getText())));
	...
	public void fluxoProblema() {
		...
		viewRendimento.getLargPeitoJFT1().setText(TextFormatter.formatString("" + lastHist.get(0).getLargPeito(), 3));
		viewRendimento.getCompPeitoJFT1().setText(TextFormatter.formatString("" + lastHist.get(0).getCompPeito(), 3));
	...
	public void fluxoCont() {
		...
		// TextFormatter.formatStringJL(viewRendimento.getOrdemLabel1(),
		// viewRendimento.getOrdemLabel1().getText(), 3);
		...
		rendimento.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel1().getText()),
				Integer.parseInt(viewRendimento.getNumJFT1().getText()), Integer.parseInt(viewRendimento.getgDirJFT1().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT1().getText()), Integer.parseInt(viewRendimento.getpCarcJFT1().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT1().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT1().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT1().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT1().getText()),
		...
		rendimento.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel2().getText()),
				Integer.parseInt(viewRendimento.getNumJFT2().getText()), Integer.parseInt(viewRendimento.getgDirJFT2().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT2().getText()), Integer.parseInt(viewRendimento.getpCarcJFT2().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT2().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT2().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT2().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT2().getText()),
		...
		rendimento.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel3().getText()),
				Integer.parseInt(viewRendimento.getNumJFT3().getText()), Integer.parseInt(viewRendimento.getgDirJFT3().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT3().getText()), Integer.parseInt(viewRendimento.getpCarcJFT3().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT3().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT3().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT3().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT3().getText()),
		...
		rendimento.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel4().getText()),
				Integer.parseInt(viewRendimento.getNumJFT4().getText()), Integer.parseInt(viewRendimento.getgDirJFT4().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT4().getText()), Integer.parseInt(viewRendimento.getpCarcJFT4().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT4().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT4().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT4().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT4().getText()),
		...
		rendimento.add(new RendimentoVOF(abate, Integer.parseInt(viewRendimento.getOrdemLabel5().getText()),
				Integer.parseInt(viewRendimento.getNumJFT5().getText()), Integer.parseInt(viewRendimento.getgDirJFT5().getText()),
				Integer.parseInt(viewRendimento.getgEsqJFT5().getText()), Integer.parseInt(viewRendimento.getpCarcJFT5().getText()),
				Integer.parseInt(viewRendimento.getpGorDirJFT5().getText()), Integer.parseInt(viewRendimento.getpGorEsqJFT5().getText()),
				Integer.parseInt(viewRendimento.getpAsaJFT5().getText()), Integer.parseInt(viewRendimento.getGorPeitoJFT5().getText()),
