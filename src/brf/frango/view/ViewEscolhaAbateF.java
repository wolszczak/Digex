...
public class ViewEscolhaAbateF extends javax.swing.JFrame {

    /**
     * Creates new form ViewEscolhaAbate
     */
    public ViewEscolhaAbateF() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEscolhaAbateF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEscolhaAbateF().setVisible(true);
            }
        });
    }
